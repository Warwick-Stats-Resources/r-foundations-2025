...
[Sign-up on SkillsForge](https://skillsforge.warwick.ac.uk/warwick/#he/dev/eventDetails,;em,providerCode=ST,providerOrgAlias=warwick,number=7,;) (or go to <https://skillsforge.warwick.ac.uk> and search for "ST7")

[Form to get credit](https://docs.google.com/forms/d/e/1FAIpQLSedLCHX19QcLwnqsxyO5slF7kk02v0ER6s_b4pJnUitSW7aPw/viewform?usp=dialog)
...
These slides are mostly copied from Tom Mock's 'Getting Started with Quarto' workshop at rstudio::conf(2022).
...
- Works in RStudio, Jupyter Notebooks, VS Code, Positron
...
## Quarto resources and inspiration
...
# YAML, text, code {.green-bg .larger200}
...
- [Slidecrafting](https://slidecrafting-book.com) by Emil Hvitfeldt
...
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Quarto Pub](https://quarto.org/docs/publishing/quarto-pub.html)           | Publishing service for Quarto documents, websites, and books.                                         |
...
| [Netlify](https://quarto.org/docs/publishing/netlify.html)                 | Professional web publishing platform.                         | 
| [Confluence](https://quarto.org/docs/publishing/confluence.html)         | Publishing platform for supporting team collaboration.  
...
# Congratulations! {.lavender-bg .center-h}

</br>

You have reached the end of R Foundations!

Please leave (anonymous) feedback to help us improve the course.

<https://warwick.ac.uk/ellakaye/r-foundations-2025-feedback>
