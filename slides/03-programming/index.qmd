...
```{r}
#| eval: false
lm(body_mass ~ bill_len + flipper_len, data = penguins) 
```
...
[Go to form](https://docs.google.com/forms/d/e/1FAIpQLSclveRrfKQdkzgG6OaUHfTLH5Bg-AItAdwAXn1BsHKX8mQ_qQ/viewform?usp=publish-editor){.larger200}
